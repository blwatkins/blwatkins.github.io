...
Navigating the new and constantly evolving landscape of artificial intelligence (AI) has become a challenge in my work, as the technical sphere, where AI use may be more accepted and even encouraged, is completely intertwined with the creative sphere, where AI use is more controversial.

In the past, I considered my identity as an engineer to be separate from my identity as an artist.
In my mind, the workflows and processes that went into building web applications and software packages were different from those that went into building an art algorithm.
But I am realizing more and more that the two are not separate; the code is my art and the art is my code.
The software packages I publish are the backbone of the art algorithms I create; they work together to form a creative ecosystem that I have been designing and building for almost five years.

After spending time experimenting with AI tools, large language models, and agentnic coding
