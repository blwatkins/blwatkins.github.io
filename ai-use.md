...
You can see an example of my AI instruction files in [`copilot-instructions.md` from my p5-webpack-typescript-template repository](https://github.com/blwatkins/p5-webpack-typescript-template/blob/main/.github/copilot-instructions.md).
...
You can see an example of my portfolio skills pages on [the GitHub Pages site of my p5-webpack-typescript-template repository](https://blwatkins.github.io/p5-webpack-typescript-template/portfolio-skills.html).
