...
To make her generative art programs, Brittni defines the rules of an artistic system using computer code (typically JavaScript or TypeScript), and the computer executes that code to produce a visual output that follows the rules of the system.
